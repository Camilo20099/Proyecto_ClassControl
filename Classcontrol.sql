...
CREATE TABLE IF NOT EXISTS `ClassControl`.`Competencias` (
  ...
  INDEX `fk_Competencias_Programas1_idx` (`Programas_idProgramas` ) ,
...
-- -----------------------------------------------------
-- Table `ClassControl`.`Vinculacion_Laboral`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ClassControl`.`Vinculacion_Laboral` (
...
-- -----------------------------------------------------
-- Table `ClassControl`.`Roles_has_Permisos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ClassControl`.`Roles_has_Permisos` (
  `Roles_id_roles` INT NOT NULL,
  ...
  CONSTRAINT `fk_Roles_has_Permisos_Permisos1`
    ...
    REFERENCES `ClassControl`.`Permisos` (`id_permisos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
